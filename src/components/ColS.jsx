    ...
    <div className='flex flex-col h-[100vh] w-full'>
      <div className="flex flex-col items-start space-y-2 w-full">
        ...
        <Link to="/Dashboard" className="w-full ">
          <button
            className='justify-center items-center w-full h-12 text-xl sm:h-16 bg-pinkii mt-8 text-dash-col rounded-[4px] outline-none border-none'
          >
            Sign Up
          </button>
        </Link>
        <div className="flex flex-row justify-center items-center font-medium text-xl space-x-4  w-full">
          ...
          <Link to="/LogIn">
            <h2 className="text-pinkii cursor-pointer">Log In</h2>
          </Link>
        </div>
      </div>
    </div>
